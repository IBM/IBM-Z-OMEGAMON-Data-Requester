...
import "./Select/components/FUIBadge.js";
import { a as t, i as n, r } from "./combobox-Cj2a0Di7.js";
import { FUIComboboxContext as i } from "./Select/components/FUIContext.js";
import "./Select/components/FUIFields.js";
import "./Select/components/FUIOption.js";
import "./Select/components/FUIButton.js";
import * as a from "react";
import { useContext as o, useEffect as s, useRef as c, useState as l } from "react";
import { jsx as u } from "react/jsx-runtime";
//#region src/Select/components/FUIBadges.tsx
function d({ children: e }) {
	let { selectedOptions: t, handleOnRemove: n = (e) => {
		console.log("FUI, WARNING! No remove option function is provided");
	} } = a.useContext(i);
	return t.map((t) => e(t, n));
}
//#endregion
//#region src/Select/components/FUICombobox.tsx
var f = (/* @__PURE__ */ e(((e, t) => {
	(function() {
...
function p({ options: e, generateOptions: t, preprocessOnChangeValues: n, allowCustomValues: a, externalOnChange: o, ...s }) {
	let d = c(null), p = c(null), [m, h] = l({
		startIdx: 0,
		endIdx: 0
	}), [g, _] = l(""), [v, y] = l(s.value || []), b = () => h({
		startIdx: p.current?.selectionStart || 0,
		endIdx: p.current?.selectionEnd || 0
	}), x = (e) => {
		let t = n(e, g, {
			startIdx: p.current?.selectionStart || 0,
			endIdx: p.current?.selectionEnd || 0
		});
		t.options && (y(t.options), _(""), p.current && (p.current.value = ""), o && o(t.options)), t.input && p.current && (p.current.value = t.input, _(t.input));
	};
...
function h({ options: e, generateOptions: t, preprocessOnChangeValues: n, allowCustomValues: a, externalOnChange: o, ...s }) {
	let d = c(null), f = c(null), [p, h] = l(""), [g, _] = l({
		startIdx: 0,
		endIdx: 0
	}), [v, y] = l(s.value || m), b = () => _({
		startIdx: d.current?.selectionStart || 0,
		endIdx: d.current?.selectionEnd || 0
	}), x = (e) => {
		if (!e) {
			h(""), y(m), o && o(null);
			return;
		...
		t.input && d.current && (h(t.input), d.current.value = t.input), t.options && (y(t.options[0]), h(""), o && o(t.options[0]));
	};
	return /* @__PURE__ */ u(i.Provider, {
		value: {
			options: e,
...
//#endregion
//#region src/Select/components/FUIInput.tsx
function g({ ...e }) {
	let { handleSetInput: n, inputRef: r, input: a, isMulti: s, handleCaretChange: c } = o(i), l = s ? {} : { displayValue: (e) => {
		if (!e) return a || "";
		let t = e;
		return t.id === -1 ? a : t.label || t.value;
	} };
	return /* @__PURE__ */ u(t, {
		...e,
		...l,
...
//#endregion
//#region src/Select/components/useComboboxSize.tsx
function _() {
	let { comboboxRef: e, input: t, selectedOptions: n } = o(i), [r, a] = l(0), [c, u] = l(0), [d, f] = l(0);
	return s(() => {
		let t = () => {
			if (e && e.current) {
				let t = e.current.getBoundingClientRect();
				a(t.bottom), u(t.width), f(t.left);
			}
		};
...
//#endregion
//#region src/Select/components/FUIOptions.tsx
function v({ children: e, ...t }) {
	let { generateOptions: r, input: o, options: s, selectedOptions: c, allowCustomValues: l = !1, isMulti: d = !1, textSelection: f } = a.useContext(i), p = r(s, d ? c : [], o, f.startIdx, l), { top: m, left: h, width: g } = _();
	return /* @__PURE__ */ u(n, {
		...t,
		style: {
			top: m,
		...
		children: p.length ? p.map((t) => e(t)) : e({
			id: -2,
...
//#endregion
export { h as a, p as i, _ as n, d as o, g as r, v as t };
