...
import { FalconDatasourceConfig_V8 } from './FalconDatasourceConfig_V8';

const FALCON_DATASOURCE_OPTIONS_VERSION_V9 = 9;

export function updateTo_V9(current: FalconDatasourceConfig_V8): FalconDatasourceConfig_V9 {
  return {
    ...current,
    jsonData: {
      ...current.jsonData,
      enableSecureSocksProxy: false,
      falconVersion: FALCON_DATASOURCE_OPTIONS_VERSION_V9,
    },
  };
}
...
type GrafanaDefineJsonData_V9 = DEP_V9.DataSourceJsonData & {
...
type FalconDatasourceJsonData_V9 = GrafanaDefineJsonData_V9 &
  DEP_V9.WithVersion<typeof FALCON_DATASOURCE_OPTIONS_VERSION_V9> & {
    metadataCacheTimeInSec: number;
    adminUrl: string;
  };

export type FalconDatasourceConfig_V9 = DEP_V9.DataSourceSettings<FalconDatasourceJsonData_V9>;
